...
export class MetadataService {
  ...
  private readonly defaultURL = 'https://Saeeh.net/';
  private readonly defaultTitle = 'Saeeh Admin';
  private readonly defaultDescription = 'Saeeh Admin';
  private readonly defaultImage =
    './assets/images/logo/logo-favicon.svg';
