...
@Component({
  standalone: true,
  imports: [FormsModule, ReactiveFormsModule, TranslateModule, CommonModule, CalendarModule], selector: 'filter-organizations',
  templateUrl: './filter-organizations.component.html',
  styleUrls: ['./filter-organizations.component.scss']
})
export class FilterOrganizationsComponent {
